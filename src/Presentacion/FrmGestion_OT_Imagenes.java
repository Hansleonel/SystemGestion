 ...
 * @author kandskat
 */
public class FrmGestion_OT_Imagenes extends javax.swing.JFrame {

    /**
     * Creates new form FrmGestion_OT_Imagenes
     */
    public FrmGestion_OT_Imagenes() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 10, 20));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 590, 60, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGestion_OT_Imagenes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmGestion_OT_Imagenes().setVisible(true);
            }
        });
    }
    ...
    private void Mostar_OT_Imagenes(String buscar) {
        try {
            DefaultTableModel model;
            L_OTImagenes func = new L_OTImagenes();
            model=func.Mostrar_OT_Imagenes(buscar);
